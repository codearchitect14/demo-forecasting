...
class RealTimeAlertsService:
    ...
    async def monitor_all_stores(self, request: Request) -> List[AlertData]: # Add request
    ...
    async def _monitor_stockout_risks(self, stores: List[Dict], request: Request) -> List[AlertData]: # Add request
    ...
    async def _monitor_demand_anomalies(self, stores: List[Dict], request: Request) -> List[AlertData]: # Add request
    ...
    async def _monitor_weather_impacts(self, stores: List[Dict], request: Request) -> List[AlertData]: # Add request
    ...
    async def _store_alerts(self, alerts: List[AlertData], request: Request) -> None: # Add request
    ...
    async def get_active_alerts(
        self, request: Request, store_id: Optional[int] = None, severity: Optional[str] = None # Add request
    ) -> List[Dict]:
    ...
    async def acknowledge_alert(self, alert_id: str, acknowledged_by: str, request: Request) -> bool: # Add request
    ...
    async def resolve_alert(self, alert_id: str, resolution_status: str, request: Request) -> bool: # Add request
    ...
    async def get_alert_summary(self, request: Request, days: int = 7) -> Dict[str, Any]: # Add request
